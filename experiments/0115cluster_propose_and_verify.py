...
if __name__ == '__main__':
    ...
    if args.verifier_model_paths is None:
        args.verifier_model_paths = 'google/flan-t5-xxl'
    
    source_limited = '' if not args.source_limited else 'source_limited'
    ...
    allowed_idxes_subset = [i for i in range(len(data_name2dicts['train'])) if data_name2dicts['train'][i]['source'] in sources]
    ...
    def get_verifier_logs(split_name, idxes=None, tag=''):
        ...
        for i in pbar:
            ...
            save_d = {'train_id': i, 'hypotheses': hypotheses, 'pos_sents': d['pos_sents'], 'neg_sents': d['neg_sents']}
        ...
        for verifier_model_path in verifier_model_paths:
            ...
            with open(save_path, 'a') as f:
                ...
                for i in pbar:
                    ...
                    pos_sents, neg_sents = d['pos_sents'], d['neg_sents']
                    ...
                    for h in hypotheses:
                        ...
                        if h_type == 'cmp':
                            ...
                            results = list(verifier.verify_ind_dicts_w_scores(dicts))
                    ...
                    save_d = {'train_id': train_id, 'hypotheses': h2result, 'pos_sents': pos_sents, 'neg_sents': neg_sents}
    ...
    if not args.no_propose:
        while True:
            ...
            random_order = allowed_idxes_subset
